      ...
      <div className="home-table2 rounded-xl">
        <div className="">
          <div className="flex justify-between items-center mb-4">
            ...
            <button className="px-4 py-2 bg-[#5884FF] text-white rounded-md">
              Add Customer
            </button>
          </div>
          ...
          <table className="w-full dash-table1 bg-white">
            ...
            >
              ...
              <th onClick={() => sortdata("name3")}>Contact</th>
              <th onClick={() => sortdata("name4")}>Address</th>
                ...
                <td>
                  <div className="flex text-center justify-evenly">
                    ...
                    <div className="py-[2px] cursor-pointer ">
                      ...
                      >
                        <path
                          d="M9.34521 1.16667L8.51188 0.375H4.34522L3.51188 1.16667H0.595215V2.75H12.2619V1.16667H9.34521ZM1.42855 13.0417C1.42855 13.9125 2.17855 14.625 3.09521 14.625H9.76188C10.6785 14.625 11.4285 13.9125 11.4285 13.0417V3.54167H1.42855V13.0417ZM3.09521 5.125H9.76188V13.0417H3.09521V5.125Z"
                          fill="#5884FF"
                        />
                      </svg>
                    </div>
        ...
        <div className=" bottom-pagination w-full right-0 flex justify-center items-center gap-2 mt-2 bg-slate-600">
          <div className="flex gap-2">
            ...
            <div
              className="home-pagination cursor-pointer home-pagination-active"
              onClick={() => setstart(0)}
            >
              1
            </div>
            <div
              className={`home-pagination cursor-pointer ${
                Math.ceil(start / interval) + 1 > 1 ? "" : "hidden"
              }`}
              style={{
                display:
                  Math.ceil(start / interval) > 0 &&
                  (Math.ceil(start / interval) + 1) * interval < state.length
                    ? "block"
                    : "none",
              }}
              onClick={() => {
              ...
              onClick={() =>
                setstart(
                  Math.max(
                    ...
                    Math.min(
                      state.length,
                      Math.floor(state.length / interval) * interval
                    )
                  )
                )
              }
            ...
            <div
              className="home-gt-btn cursor-pointer"
              onClick={() => {
                if (start + interval < state.length)
                  setstart(Math.min(state.length, start + interval));
              }}
            >
              Next &nbsp; &gt;
            </div>
