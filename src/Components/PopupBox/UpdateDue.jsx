...
const UpdateDue = ({ ids, setids }) => {
  return (
    <>
    <div className={`${ids === 9 ? "" : "hidden"}`}>
        <div className='bg-white m-auto w-[379px] mt-[15%] p-4 flex flex-col gap-6 rounded-xl'>
            <div className='' onClick={() => { setids(0) }}>
                ...
                <div className=''>
                    <h1 className='text-[1.5rem] text-center'>Update Due</h1>
            ...
            <div className='mt-4'>
                <form className='bg-[#F5F5F5]'>
                    <label className='px-[10px] font-semibold text-[17px]'>Due Amount</label>
                    <div className=''>
                        <input type='number' placeholder='Due Amount' className='login-input3 w-full' />
                    </div>
                </form>
