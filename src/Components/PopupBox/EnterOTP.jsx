...
const EnterOTP = ({ids, setids}) => {
    return (
        <div className={`${ids===2?"":"hidden"}`}>
            <div className='bg-white m-auto w-[379px] mt-[15%] p-4 flex flex-col gap-6 rounded-xl'>
                ...
                <div className=''>
                    <h1 className='text-[1.5rem]'>Enter OTP</h1>
                </div>
                <div className=''>
                    <form className=''>
                        <div className=''>
                            <input type='number' placeholder='OTP' className='login-input2 w-full' />
                        </div>
                        <div className='flex justify-center items-center mt-8 mb-6'>
                            <div className='btn' onClick={() => { setids(3) }}>Verify</div>
                        </div>
                    </form>
                </div>
            </div>
