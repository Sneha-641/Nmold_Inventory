...
const NewPassword = ({ids, setids}) => {
  return (
    <>
            <div className={`${ids===3?"":"hidden"}`}>
                <div className='bg-white m-auto w-[379px] mt-[15%] p-4 flex flex-col gap-6 rounded-xl'>
                    <div className=''  onClick={()=>{setids(1)}}>
                    ...
                    <div className=''>
                        <h1 className='text-[1.5rem]'>Enter New Password</h1>
                    </div>
                    <div className=''>
                        <form className=''>
                        <div className=''>
                                <input type='password' placeholder='Password' className='login-input2 w-full' />
                            </div>
                            <div className='mt-4'>
                                <input type='password' placeholder='Confirm Password' className='login-input2 w-full' />
                            </div>
                            <div className='flex justify-center items-center mt-8 mb-6'>
                                <div className='btn' onClick={()=>{setids(0)}}>Reset</div>
                            </div>
                        </form>
                    </div>
                </div>
