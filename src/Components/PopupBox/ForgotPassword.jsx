...
const ForgotPassword = ({ids, setids}) => {
    return (
        <>
            <div className={`${ids===1?"":"hidden"}`}>
                <div className='bg-white m-auto w-[379px] mt-[15%] p-4 flex flex-col gap-6 rounded-xl'>
                    ...
                    <div className=''>
                        <form className=''>
                            <div className=''>
                                <input type='email' placeholder='Email' className='login-input2 w-full' />
                            </div>
                            <div className='flex justify-center items-center mt-8 mb-6'>
                                <div className='btn' onClick={()=>{setids(2)}}>Send Email</div>
                            </div>
                        </form>
                    </div>
                </div>
